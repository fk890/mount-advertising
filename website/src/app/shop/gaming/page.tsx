    ...
    const fetchProducts = async () => {
      try {
        ...
        const filtered = fetched.filter((product: Product) => {
          ...
          return category === 'gaming' || collection === 'gaming' || id.startsWith('gaming-')
        })
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '18px', color: '#9CA3AF', maxWidth: '600px', margin: '0 auto' }}>
            Level up your gaming setup with epic neon signs. Perfect for streamers, esports rooms, and gaming enthusiasts.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '48px' }}>
            <p style={{ color: '#9CA3AF', fontSize: '18px' }}>No gaming products available yet. Check back soon!</p>
          </div>
        )}
      </div>
    </div>
