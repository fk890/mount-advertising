...
export default function CafeProductPage() {
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {/* Title & Price */}
            <div>
              <p style={{ color: '#00ff00', fontSize: '14px', fontWeight: 500, marginBottom: '8px' }}>CAFE COLLECTION</p>
                ...
                {sizes.map((size) => (
                  <button
                    ...
                    style={{
                      padding: '12px 8px',
                      borderRadius: '8px',
                      border: selectedSize.id === size.id ? '2px solid #00ff00' : '2px solid #374151',
                      backgroundColor: selectedSize.id === size.id ? 'rgba(0, 255, 0, 0.1)' : '#1a1a1a',
                      color: '#fff',
                      cursor: 'pointer',
                      textAlign: 'center',
                    }}
            ...
            {(['details', 'specs', 'shipping'] as const).map((tab) => (
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  color: activeTab === tab ? '#00ff00' : '#9CA3AF',
                  fontSize: '16px',
                  fontWeight: 500,
                  cursor: 'pointer',
